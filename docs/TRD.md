...
Each environment owns its own GCP/Firebase project, Firebase iOS app, App Check configuration, backend endpoints, PostHog configuration, GitHub Environment secret/variable set, and Terraform state.
