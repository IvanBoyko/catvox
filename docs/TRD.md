...
* [x] **Backend Integration Test Baseline:** TypeScript backend integration suite verifies that both live HTTP Functions reject missing App Check tokens with `401 app_check_unauthorized`, and verifies the live Dev backend daily-quota `429` body, `Retry-After`, and structured Cloud Logging event after merge-to-main deploys or local Dev CLI runs. See ADR-0013.
